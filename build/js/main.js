...
$(document).ready(function () {
  ...
  if (selectAddress.length > 0) {
    ...
    selectAddress.on('beforeChange', function (event, slick, currentSlide, nextSlide) {
      $('.select-address__item[data-slick-index="' + nextSlide + '"]').find('input[type="radio"]').focus().prop('checked', true);
  ...
  if (contactMap.length > 0) {
    var createMap = function createMap(groups) {
  ...
  if (catalogFancybox.length > 0) {
    $('body').on('click', '.catalog-fancybox', function () {
      ...
      var isAttrDataLoadNext = typeof isNextPage.attr('data-load') !== 'undefined';
      var isAttrDataLoadPrev = typeof isPrevPage.attr('data-load') !== 'undefined';
            ...
            afterShow: function afterShow(instance) {
              $.ajax({
                ...
                success: function success(data) {
                  ...
                  var catalogModalThumb = windowThumbs.find('.catalog-modal__thumbs-item');
                  ...
                  if (catalogModalThumb.length > 0) {
                    ...
                    windowThumbs.on('beforeChange', function (event, slick, currentSlide, nextSlide) {
                      var hrefBigSlide = $(this).find("[data-slick-index=" + nextSlide + "] a").attr('href');
